...
public class Demo12_Screenshot {
...
//		byte[] screenshot = page.screenshot();
        ...
        page.screenshot(new ScreenshotOptions().setPath(Paths.get("./snaps/full.png")).setFullPage(true));
        Locator searchLocator = page.getByPlaceholder("Search");
        searchLocator.click();

        searchLocator.screenshot(new Locator.ScreenshotOptions().setPath(Paths.get("./snaps/initial.png"))
                .setCaret(ScreenshotCaret.INITIAL));
        searchLocator.screenshot(new Locator.ScreenshotOptions().setPath(Paths.get("./snaps/hide.png"))
...
//				.setMask(Arrays.asList(searchLocator)));
        page.screenshot(new ScreenshotOptions().setPath(Paths.get("./snaps/initial.png"))
                .setCaret(ScreenshotCaret.INITIAL)
                .setMask(Arrays.asList(searchLocator)));
