...
context.tracing().stop(new Tracing.StopOptions()
  ...
  3. To open the trace
   ...
   Option 2 - mvn exec:java -e -D exec.mainClass=com.microsoft.playwright.CLI -D exec.args="show-trace C:\Users\delltest03\Playwright_Demo_Code\StarkTechDemo.zip"
...
public class Demo5_TraceViewer
{
    public static void main(String[] args) {
        try (Playwright playwright = Playwright.create()) {
            ...
            context.tracing().stop(new Tracing.StopOptions()
                    .setPath(Paths.get("StarkTechDemo.zip")));
